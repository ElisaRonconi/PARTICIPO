...
INSERT INTO `alumnos` (`idAlumno`, `nombre`, `apellido`, `email`, `fechaNacimiento`, `dni`, `idInstituto`, `idUsuario`) VALUES
	(1, 'Juan', 'Perez', 'juan.perez@example.com', '2000-01-01', '12345678', NULL, NULL),
	(2, 'Menganito', 'Lopez', 'menganito@example.com', '2001-09-06', '87654321', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `materias` (
  ...
  KEY `FK_materias_alumnos` (`idAlumno`),
  CONSTRAINT `fk_materia_instituto` FOREIGN KEY (`idInstituto`) REFERENCES `institutos` (`idInstituto`),
  CONSTRAINT `FK_materias_alumnos` FOREIGN KEY (`idAlumno`) REFERENCES `alumnos` (`idAlumno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

...
<div class="container">
    ...
    <?php else: ?>
        <p style="color:#239eb1; text-align:center; font-size:20px; font-weight:bold;">
            No hay alumnos inscritos en esta materia. <br><br>
            Verificar la correcta selección de Instituto.
        </p>
    <?php endif; ?>
</div>
</body>
